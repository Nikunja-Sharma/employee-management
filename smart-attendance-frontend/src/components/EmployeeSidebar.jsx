      ...
      >
        ...
        <div>
          ...
          <nav className="p-4 space-y-2">
            ...
            <Link to="/employee/dashboard" className={linkClass("dashboard")} onClick={handleLinkClick}>
              Dashboard
            </Link>

            <Link to="/employee/scan" className={linkClass("scan")} onClick={handleLinkClick}>
              Scan QR
            </Link>

            <Link to="/employee/history" className={linkClass("history")} onClick={handleLinkClick}>
              History
            </Link>

            <Link to="/employee/leaves" className={linkClass("leaves")} onClick={handleLinkClick}>
              My Leaves
            </Link>

            <Link to="/employee/report" className={linkClass("report")} onClick={handleLinkClick}>
              My Report
            </Link>
